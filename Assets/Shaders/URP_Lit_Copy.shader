Shader "Custom/URP_Lit_Copy"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                // inputData.shadowAttenuation = mainLight.shadowAttenuation;
    ...
    // FallBack "Hidden/InternalErrorShader"   //fallbacks are not supported in URP
}
